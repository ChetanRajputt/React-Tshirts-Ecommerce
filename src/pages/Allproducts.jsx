...
const AllProducts = () => {
  // for Open Filter Modal and Product Filter Features
  ...
  return (
    <main className='bg-[#F5F5F5] w-full'>
      ...
      {isFilterModalOpen && (
        <div className="fixed inset-0 z-50 flex justify-start">
          ...
          <div className="relative w-64 h-full p-4 bg-white">
            <button onClick={() => setIsFilterModalOpen(false)} className="absolute right-0 mb-4 mr-3"><IoMdClose size={30} /></button>
      ...
      <div className="container text-[#5c636b] flex justify-between items-center py-14 px-8 lg:px-0">
        ...
        <select value={sortOption} onChange={(e) => handleSortChange(e.target.value)} className="text-xl text-black">
