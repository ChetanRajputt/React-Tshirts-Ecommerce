...
// why not use this because its show for products that don't have 4 more products

const RelatedProductCard = ({ id, name, category, image, price, originalPrice, isModalOpen, setIsModalOpen, currentModalId, setCurrentModalId }) => {
    ...
    return (
        <div className='w-[200px] lg:w-[280px] hover:shadow-xl cursor-pointer transition-all duration-300 '>
            <div className='w-full overflow-hidden relative group transition-all duration-300'>
